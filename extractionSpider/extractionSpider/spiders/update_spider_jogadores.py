...
from db.querys_insert_update.update_values import update_jogadores
from utils.db_utils.execute_query import query_insert_execute
import time

class UpdateJogadoresSpider(scrapy.Spider):
    name = 'updateJogadores'
    ...
    def parse(self, response):
        ...
        for row in rows_jogador:
            try:
                ...
                query = update_jogadores(id_, nome_jogador, time_jogador)
